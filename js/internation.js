...
//					  div.style.fontSize='15px';
				...
				setInterval(function() {
					var futureTime = new Date("2017/10/01 01:00:00");
					var nowTime = new Date();
					var sumSM = futureTime.getTime() - nowTime.getTime();
					//天的获取
					var day = parseInt(sumSM / 1000 / 60 / 60 / 24);
					...
					div1.innerHTML = "距离活动结束还有:" + day + "天" + hour + "时" + min + "分" + second + "秒"
//					  
//					  div.style.fontSize='15px';
				...
				setInterval(function() {
					...
					div2.innerHTML = "距离活动结束还有:" + day + "天" + hour + "时" + min + "分" + second + "秒"
//					  
//					  div.style.fontSize='15px';
				...
				setInterval(function() {
					...
					div3.innerHTML = "距离活动结束还有:" + day + "天" + hour + "时" + min + "分" + second + "秒"
//					  
//					  div.style.fontSize='15px';
